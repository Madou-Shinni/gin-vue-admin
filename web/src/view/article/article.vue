  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="分类" prop="categoryId" width="120">
            ...
            {{ filterDict(scope.row.categoryId,$category__id__nameOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="文章名称" prop="name" width="120" />
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="分类:"  prop="categoryId" >
              <el-select v-model="formData.categoryId" placeholder="请选择分类" style="width:100%" :clearable="true" >
                <el-option v-for="(item,key) in $category__id__nameOptions" :key="key" :label="item.label" :value="item.value" />
              </el-select>
            </el-form-item>
            <el-form-item label="文章名称:"  prop="name" >
              <el-input v-model="formData.name" :clearable="true"  placeholder="请输入文章名称" />
            </el-form-item>
          </el-form>
      </el-scrollbar>
      <template #footer>
      ...
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                <el-descriptions-item label="分类">
                        {{ filterDict(formData.categoryId,$category__id__nameOptions) }}
